...
public class tracker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView btn = findViewById(R.id.tv_faq);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(tracker.this, faq.class));
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(tracker.this, "Logged out successfully", Toast.LENGTH_SHORT).show();
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(tracker.this, "Something went amiss. Please try again later", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public Map<String, String> getHeaders() {
                ...
                headers.put("X-CMC_PRO_API_KEY", "a029be93-773f-4364-b742-1608b97e8a65");
